...
import { DollarSign, PlusCircle, Edit2, Trash2, Building2, Loader2, TrendingUp, Calendar } from 'lucide-react'
            ...
            {isLoading ? (
                ...
                <div className="space-y-4">
                    {filteredExpenses.map(expense => (
                        <div key={expense.id} className="bg-white p-6 rounded-2xl border border-slate-200 hover:shadow-lg transition-all">
